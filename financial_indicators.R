...
download.file("https://databank.worldbank.org/data/download/WDI_csv.zip",
              ...
              method="wget",quiet=FALSE,mode="w",cacheOK=FALSE,extra=getOption("download.file.extra"),headers=NULL)
...
df<-read.csv(paste0(directory,"data/WDIData.csv"),stringsAsFactors=FALSE)
...
psycholatefunctions::cdf(mfi)
psycholatefunctions::cdf(mfi_cor)
psycholatefunctions::cdf(mfi_population)
