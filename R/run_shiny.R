...
# SERVER
##########################################################################################
#' @title World Bank Data Visualization Server Logic
#'
#' @description
#' Server-side logic for a Shiny web application that visualizes World Bank data using Plotly charts.
#' It includes interactive visualizations such as country comparisons, indicator trends, population pyramids,
#' bar plots, scatterplots, choropleth maps, and a searchable indicator index.
#'
#' @param input,output Internal Shiny input/output objects (automatically passed by Shiny).
#'
#' @details
#' This server function includes:
#' \describe{
#'   \item{\code{observeEvent}}{Synchronizes indicator options based on selected country/countries.}
#'   \item{\code{renderPlotly}}{Generates interactive plots for each tab using Plotly:
#'     \itemize{
#'       \item Line plots for time-series indicator comparison
#'       \item Animated population pyramids
#'       \item Barplot rankings of countries by indicator
#'       \item Animated choropleth maps of indicators
#'       \item Animated scatterplots to show correlations
#'     }}
#'   \item{\code{renderDataTable}}{Generates an index of available indicators.}
#' }
#'
#' Responsive behavior is handled by JavaScript listeners that capture browser dimensions for dynamic plot sizing.
#' Data filtering ensures complete cases are plotted, and animation frames are created based on year.
#'
#' @return None. Used for side effects in Shiny app.
#'
#' @import shiny
#' @import plotly
#' @importFrom DT datatable renderDataTable formatStyle
...
# UI
##########################################################################################
#' @title World Bank Data Visualization UI
#'
#' @description
#' The UI definition for a Shiny application that allows users to explore and visualize
#' World Bank data using Plotly interactive charts. The interface includes multiple tabs
#' for comparing countries and indicators, viewing population pyramids, barplots,
#' scatterplots, and choropleth maps. A summary data table is also included.
#'
#' @details
#' The UI includes the following tabs:
#' \describe{
#'   \item{Country Comparison}{Compare a single indicator across multiple countries.}
#'   \item{Indicator Comparison}{Compare multiple indicators for a single country.}
#'   \item{Pyramid}{Displays population pyramid for a selected country.}
#'   \item{Barplot}{Visualizes a selected indicator across all countries.}
#'   \item{Scatterplot}{Shows correlation between two indicators across countries.}
#'   \item{Map}{Choropleth map showing geographic distribution of a selected indicator.}
#'   \item{Index}{Table output of the World Bank dataset.}
#' }
#'
#' Additional features:
#' \itemize{
#'   \item Responsive behavior using JavaScript to capture window size.
#'   \item Dynamic, searchable select inputs with Selectize.
#'   \item Plotly for interactive, zoomable, hover-enabled charts.
#'   \item Compact navbar styling for improved layout efficiency.
#' }
#'
#' @return A `tagList` object containing the Shiny UI layout.
#' @import shiny
#' @import plotly
